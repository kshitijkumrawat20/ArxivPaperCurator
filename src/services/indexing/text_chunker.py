                ...
                return [
                    TextChunk(
                        ...
                        metadata=ChunkMetadata(
                            ...
                            overlap_with_previous_chunk=0,
                            overlap_with_next_chunk=0,
                        ),
                        arxiv_id=arxiv_id,
                        paper_id=paper_id,
                    )
        ...
        while current_position < len(words):
            ...
            chunk = TextChunk(
                ...
                metadata=ChunkMetadata(
                    ...
                    overlap_with_previous_chunk=overlap_with_previous,
                    overlap_with_next_chunk=overlap_with_next,
        ...
        for i, chunk in enumerate(traditional_chunks):
            ...
            enhanced_chunk = TextChunk(
                ...
                metadata=ChunkMetadata(
                    ...
                    overlap_with_previous_chunk=chunk.metadata.overlap_with_previous_chunk,
                    overlap_with_next_chunk=chunk.metadata.overlap_with_next_chunk,
