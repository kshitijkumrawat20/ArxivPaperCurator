...
from .utils import get_latest_query, get_latest_context 
...
async def ainvoke_generate_answer_step(
    ...
    # count sources from relevant sources 
    ...
    # logger.debug(f"Sources used: {sources_count}")
    ...
    if runtime.context.langfuse_enabled and runtime.context.trace: 
        ...
        try:
            # Create answer generation prompt from tempelate 
            ...
            logger.error(f"LLM answer generation failed : {e}, falling back to error messages")
