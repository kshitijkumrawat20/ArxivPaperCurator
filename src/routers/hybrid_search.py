...
from src.dependencies import OpenSearchDep, EmbeddingsDep
from src.schema.api.search import SearchHit, SearchRequest, SearchResponse, HybridSearchRequest
...
async def hybrid_search(request: HybridSearchRequest, opensearch_client: OpenSearchDep, embeddings_service: EmbeddingsDep) -> SearchResponse:
    """
    ...
    try:
        ...
        if request.use_hybrid:
            try: 
                ...
                logger.info("Generated query embedding for hubrid search.")
